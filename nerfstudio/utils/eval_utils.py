...
def eval_load_checkpoint(config: TrainerConfig, pipeline: Pipeline) -> Tuple[Path, int]:
    ...
    # loading Nerfstudio checkpoints because they contain non-tensor objects
    # (e.g., NumPy scalars). We explicitly set weights_only=False to restore
    # the previous behavior. Safe here since the checkpoint is locally generated.
